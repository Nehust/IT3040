...
public:
    ...
    //# Hàm nhân 2 BigNum và trả về BigNum kết quả
    ...
    //# Hàm nhân BigNum với 1 số nguyên và trả về BigNum kết quả
    //# Hàm này có thể được tối ưu hóa hơn nữa bằng cách sử dụng FFT
...
int main() {
    ...
    BigNum result_55 = a_55 * b_55 + a_55 * c1 + b_55 * c2;

    std::cout << result_55 << '\n';
    return 0;
}
// Bài 2.1 3 - Phạm Ngọc Tuyên - 20235455